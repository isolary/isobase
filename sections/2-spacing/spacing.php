            ...
            <section id="values" class="text-component explain">
                ...
                <div class="demo demo--light">
                    <div class="app flex">
                        ...
                        <div data-sketch-symbol="spacing/mobile/@spacing-md" class="spacer spacer--md flex flex--center"></div>
                ...
                <div class="demo demo--light">
                    <div class="desktop flex">
                        ...
                        <div data-sketch-symbol="spacing/desktop/@spacing-md" class="spacer spacer--md flex flex--center"></div>
